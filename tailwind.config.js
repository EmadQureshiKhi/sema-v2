...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // KPMG Professional Color Palette
        kpmg: {
          blue: {
            50: '#f0f7ff',
            100: '#e0efff',
      ...
      boxShadow: {
        ...
        'glow': '0 0 20px rgba(6, 107, 179, 0.3)',
